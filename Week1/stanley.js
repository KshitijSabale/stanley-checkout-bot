...
// for type - use type and no evaluate 
// for button - use evaluate 
...
async function fillPaymentForm(page) {
    try {
        ...
        // Wait for page to load
        await delay(5000); // remove commented code 

        // fill card number
        const cardNumberSuccess = await waitForSelectorAndFill(page, '#number', '4539976554584618'); // dont wait // try to fix with iframe 
